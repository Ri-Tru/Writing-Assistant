...
Writing Assistant无额外依赖，若需要高级Markdown预览（如mermaid图表预览），可安装扩展Markdown Preview Enhanced。
...
[查看详细配置说明](../CONFIG/CONFIG.zh-cn.md#1.术语管理)  
[查看术语档案编写规范](../CONFIG/CONFIG.zh-Cn.md#术语档案编写规范)
...
[查看详细配置说明](../CONFIG/CONFIG.zh-cn.md#2.字数统计)

...
Version: V1.0, Last updated: 2026-05-30
...
You can help by doing translation works.Currently,any language except Chinese are translated from Chinese version by AI.
...
Writing Assistant has no extra dependencies. Just ensure your VSCode default encoding is correct (for Chinese, utf-8 by default, no need to change).  
...
[Detailed Configuration Guide](../CONFIG/CONFIG.md)
...
[View Detailed Configuration](../CONFIG/CONFIG.md##1.Term Management)
[View Term Definition Specification](../CONFIG/CONFIG.zh-cn.md##Term-Definition Specification)
...
[View Detailed Configuration](../CONFIG/CONFIG.md#2.Word Count)
...
A5: Add an `@hover` directive at the beginning of the term definition file. See the [Configuration Guide for details](../CONFIG.md#1.Term Management).
